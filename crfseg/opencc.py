...
if __name__ == "__main__":
  ...
  with OpenCC() as converter:
    #path = ['simp_to_trad_characters.ocd', 'simp_to_trad_phrases.ocd']
    path = ['trad_to_simp_characters.ocd', 'trad_to_simp_phrases.ocd']
    converter.dict_load(path[0], DictType.DATRIE)
    converter.dict_load(path[1], DictType.DATRIE)
    print converter.convert(text.encode('utf-8'))
